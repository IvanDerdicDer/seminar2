...
\begin{lstlisting}[
    language=Python, 
    caption={Dio skripte koja stvara tablicu `fact\_table' u Jezerskom Skladištu Podataka.}, 
...
Kod unosa podataka u zlatni sloj potrebno je kreirati tablice
`most\_bought\_colour\_per\_month', `person\_spent' i `spent\_per\_day'.
Programski kod~(\ref{lst:spent_per_day}) prikazuje dio skripte koja stvara
tablicu `spent\_per\_day' u Jezerskom Skladištu Podataka. Za kreiranje tablice
...
\begin{lstlisting}[
    language=Python, 
    caption={Dio skripte koja stvara tablicu `spent\_per\_day' u Jezerskom Skladištu Podataka.}, 
